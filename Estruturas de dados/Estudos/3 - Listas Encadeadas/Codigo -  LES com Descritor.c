...
// FAZER Copia_listas   (Tdescritorno_ls *pdesc_origem, Tdescritorno_ls *pdesc_destino) // copia os dados de uma lista 1 para uma lista 2
...
// cria uma lista com 3 nós
int Inicializar_LS_3      (Tdescritorno_ls *pdesc)
{
    Inicializar_LS (pdesc);
    Inserir_inicio_LS (pdesc, 10);
    Inserir_inicio_LS (pdesc, 20);
    Inserir_inicio_LS (pdesc, 30);
}
